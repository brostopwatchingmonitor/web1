...
<html>
  ...
  <body>
    ...
    <div class="page-content">
        ...
        <div>
            <form action="{{ url('update_faq',$faq->id) }}" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="div-center mb-3 ">
                    <label for="exampleFormControlInput1" class="form-label">Faq Title</label>
                    <input type="title" name="title" class="form1-control" value="{{ $faq->title }}" valid="exampleFormControlInput1">
                </div>
                {{-- <div class="div-center mb-3 ">
                ...
                <div class="div-center mb-3 d-flex align-items-center justify-content-center">
                    ...
                    <textarea name="description" class="form1-control" id="exampleFormControlTextarea1" rows="3">{{ $faq->description }}</textarea>
                </div>
                <div class="div-center mb-3 ">
