        ...
        <div>
            <form action="{{ url('update_post',$post->id) }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="div-center mb-3 ">
                    ...
                    <input type="title" name="title" class="form1-control" value="{{ $post->title }}" valid="exampleFormControlInput1">
                </div>
                <div class="div-center mb-3 ">
                    <label for="exampleFormControlInput1" class="form-label">Topic</label>
                    <input type="title" name="topic" class="form1-control" value="{{ $post->topic }}" valid="exampleFormControlInput1">
                </div>
                {{-- <div class="div-center mb-3 ">
                ...
                <div class="div-center mb-3 d-flex align-items-center justify-content-center">
                    ...
                    <textarea name="description" class="form1-control" id="exampleFormControlTextarea1" rows="3">{{ $post->description }}</textarea>
                </div>
                <div class="div-center mb-3">
                <label class="form-label">Old Image</label>
                <img class="form1-control" src="/postimage/{{ $post->image }}" alt="old image">
            </div>
                <div class="div-center mb-3 ">
