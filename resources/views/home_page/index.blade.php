...
<section id="services" class="services section">
  ...
  <div class="container" data-aos="fade-up">
      <div class="d-flex justify-content-center mb-4" data-aos="fade-up">
          <button class="btn btn-primary mx-2" type="button" onclick="showCategory('software')">Software</button>
          <button class="btn btn-primary mx-2" type="button" onclick="showCategory('hardware')">Hardware</button>
          <button class="btn btn-primary mx-2" type="button" onclick="showCategory('maintenance')">Maintenance</button>
          <button class="btn btn-primary mx-2" type="button" onclick="showCategory('networking')">Networking</button>
      </div>
      ...
      <div class="mt-3" id="cardExample">
          <div class="card" style="border: 0px">
              <div class="container py-5">
                  <!-- Software Services -->
                  <div class="service-category" id="software" style="display: block;" data-aos="fade-up">
                      <div class="row flex-nowrap overflow-auto">
                          @foreach ($software as $service)
                          <div class="col-md-4 col-lg-3 flex-shrink-0" data-aos="zoom-in">
                              <div class="service-item h-100">
                                  <div class="img" style="height: 300px; overflow: hidden;">
                                      <img src="{{ asset('storage/'.$service->image1) }}" class="img-fluid rounded" style="width: 100%; height: 100%; object-fit: cover;" alt="Service Image">
                                  </div>
                  ...
                  <!-- Hardware Services -->
                  <div class="service-category" id="hardware" style="display: none;">
                      <div class="row flex-nowrap overflow-auto">
                  ...
                  <div class="service-category" id="maintenance" style="display: none;">
                      <div class="row flex-nowrap overflow-auto">
                  ...
                  <!-- Networking Services -->
                  <div class="service-category" id="networking" style="display: none;">
                      <div class="row flex-nowrap overflow-auto">
...
<script>
  ...
  // Set the default category to be displayed on page load
  document.addEventListener("DOMContentLoaded", function() {
      showCategory('software'); // Show software by default
  });
</script>
